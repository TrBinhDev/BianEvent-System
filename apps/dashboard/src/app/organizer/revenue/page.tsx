    ...
    return (
      <>
        ...
        <div className="max-w-xl mx-auto space-y-4">
          <div className="ci-skeleton h-8 bg-[#f0ebe3] rounded w-1/3" />
          <div className="ci-skeleton h-64 bg-[#f0ebe3] rounded-xl" />
          <div className="ci-skeleton h-48 bg-[#f0ebe3] rounded-xl" />
        </div>
      </>
    );
  ...
  return (
    <>
      ...
      <div className="ci-container">
        {/* Back link */}
        <Link href={`/events/${id}`} className="ci-back">
          <ChevronLeft size={16} />
          Quay lại event
        </Link>
